...
const challenges_schema_1 = require("./schema/challenges.schema");
...
ChallengesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Challenge', schema: challenges_schema_1.ChallengeSchema }]),
        ],
